...
if __name__ == '__main__':
    ...
    for test_dataset, test_data_list in zip(test_datasets, test_datasets_data):
        ...
        test_df["reward_model"] = test_df["reward_model"].apply(lambda x: {"style": x["style"], "ground_truth": str(x["ground_truth"])})
    ...
    train_df["reward_model"] = train_df["reward_model"].apply(lambda x: {"style": x["style"], "ground_truth": str(x["ground_truth"])})
